...
import ImageCarousel from "../components/ImageCarousel" // Assurez-vous d'importer ImageCarousel depuis le bon emplacement
...
function Home() {
  const carouselImages = [gameboy2, gameboy3, gameboy4, gameboy6, psp1]

  return (
    <div>
      <h1>Welcome to our Website</h1>
      <ImageCarousel images={carouselImages} />{" "}
      {/* Utilisez ImageCarousel avec les images */}
      ...
      {/* Utilisation de AccueilCard avec des données réelles */}
      <AccueilCard
      ...
      />
      {/* Utilisation de Produits avec des données réelles */}
      <Produits
        product={{
      ...
      />
      {/* Ajoutez autant d'instances de Produits que nécessaire avec différentes données */}
    </div>
  )
}
